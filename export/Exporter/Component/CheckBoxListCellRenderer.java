 ...
 * @param <E>
 */
public class CheckBoxListCellRenderer<E extends CheckBoxListNode> extends MouseAdapter implements ListCellRenderer<E> {
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON1) {
            ...
            if (index >= 0) {
                ...
                DefaultListModel<CheckBoxListNode> m = (DefaultListModel<CheckBoxListNode>) l.getModel();
                CheckBoxListNode n = m.get(index);
                m.set(index, new CheckBoxListNode(n.text, !n.selected));
